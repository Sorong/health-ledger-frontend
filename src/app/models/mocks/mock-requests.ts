...
export const REQUESTS: RequestForm[] = [
  { id: 'zyx', requester: 'Dein Versicherer', requesterPublicKey: '1337', note: 'Einblick fuer Bezahlvorgang', duration: 42, treatment: true, attestation: true, recipe: true, Result: {rejected: null, reason: 's ok', treatment: []} },
