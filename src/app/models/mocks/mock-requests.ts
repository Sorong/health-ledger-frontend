...
export const REQUESTS: RequestForm[] = [
  { id: 'zyx', requester: 'Dein Versicherer', requesterPublicKey: '1337', note: 'Einblick fuer Bezahlvorgang', duration: 42, treatment: true, attestation: true, recipe: true, Result: {rejected: null, reason: 's ok', treatment: TREATMENT} },
  { id: 'yxw', requester: 'Dein Arbeitgeber', requesterPublicKey: '4242', note: 'Krankschreibung einsehen', duration: 12, treatment: false, attestation: true, recipe: false, Result: {rejected: null, reason: 'muss ja', treatment: []} },
